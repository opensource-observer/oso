...
db_password = "XUcpFzkN2wVfmeg7"
# url to connect to mongodb database
mongo_uri = f"mongodb+srv://evanameyer1:{db_password}@cluster0.my2lr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
# openai api key
    ...
    for dataset in working_data.keys():
        if dataset != '_id':
            for table in dataset:
                keys.append(f"{dataset}.{table['table_name']}")
    keys = set(keys)
