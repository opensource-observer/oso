...
2022-08-28 00:00:00.000 UTC,123,[[0x1111111111111111111111111111111111111111 0x1111111111111111111111111111111111111111 1000000 1000000 1] [0x2222222222222222222222222222222222222222 <nil> 2000000000000 2000000000000 2] [<nil> 0x3333333333333333333333333333333333333333 3000000000000000000000000 3000000000000000000000000 3]]
`.trim();
...
describe("SafeAggregate", () => {
  ...
  test("should aggregrate safe values in the csv", () => {
    ...
    expect(agg.l2GasUsed).toEqual("60002");
    expect(agg.l1GasUsed).toEqual("60001");
