...
//   findGithubRepos(filter?: string[]): Promise<Project[]>;
// }
...
//   constructor(repo: ProjectRepository, recorder: IEventRecorder) {
//     this.repo = repo;
...
//       [ArtifactNamespace.GITHUB, ArtifactNamespace.GITHUB_USER, ArtifactNamespace.GITHUB_ORG]
//     );
...
//     const projects = await this.repo.findGithubRepos();
