...
class GetDataIngestionConfigDatasetsEdgesNodeTypeDefinitionDataIngestionDefinition(
    ...
    data_ingestion: Optional[
        "GetDataIngestionConfigDatasetsEdgesNodeTypeDefinitionDataIngestionDefinitionDataIngestion"
    ] = Field(alias="dataIngestion")


class GetDataIngestionConfigDatasetsEdgesNodeTypeDefinitionDataIngestionDefinitionDataIngestion(
    BaseModel
):
    id: str
...
class GetDataIngestionConfigDatasetsEdgesNodeTypeDefinitionDataConnection(BaseModel):
