...
SELECT
  @oso_id('OSS_DIRECTORY', 'oso', name) AS project_id, /* id is the SHA256 of namespace + slug */ /* We hardcode our namespace "oso" for now */ /* but we are assuming we will allow users to add their on the OSO website */
