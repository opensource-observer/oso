MODEL (
  name oso.int_events__github_unified,
...
WITH raw_events AS (
  ...
  /* Pull Request Merge Events (since 20251007) */
  SELECT
    event_time,
    type AS event_type,
    id::TEXT AS event_source_id,
