...
WITH github_commits AS (
  ...
  SELECT
    ...
    event_source_id,
    event_source,
    @oso_entity_id(UPPER(event_source), LOWER(to_namespace), LOWER(to_name)) AS to_artifact_id,
    to_name AS to_artifact_name,
    to_namespace AS to_artifact_namespace,
    to_type AS to_artifact_type,
    to_artifact_source_id,
    @oso_entity_id(UPPER(event_source), LOWER(from_namespace), LOWER(from_name)) AS from_artifact_id,
