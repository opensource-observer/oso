...
WITH base_transactions AS (
  SELECT
    ...
    @oso_entity_id(chain, '', from_address_tx) AS from_address_tx_id,
    @oso_entity_id(chain, '', to_address_trace) AS to_address_trace_id,
    @oso_entity_id(chain, '', to_address_tx) AS to_address_tx_id
