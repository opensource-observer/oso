model(name oso.int_sbom_artifacts, kind full,)
;
...
from sbom_artifacts
left outer join
    oso.int_all_artifacts as all_repos
...
left outer join
    oso.int_all_artifacts as all_packages
...
left outer join
    oso.int_all_artifacts as deps_dev_repos
