MODEL (
  name oso.int_pln_developer_lifecycle_monthly_enriched,
  description 'Developer lifecycle states for Protocol Labs Network developers with full/part time classification and state transitions, enriched with project and developer information',
  dialect trino,
  kind full,
...
FROM oso.int_pln_developer_lifecycle_monthly AS lifecycle
