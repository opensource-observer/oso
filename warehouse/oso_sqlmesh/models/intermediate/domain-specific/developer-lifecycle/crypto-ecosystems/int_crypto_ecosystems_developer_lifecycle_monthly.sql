MODEL (
  name oso.int_crypto_ecosystems_developer_lifecycle_monthly,
  description 'Developer lifecycle states for Crypto Ecosystems with full/part time classification and state transitions',
  dialect trino,
  kind full,
