...
def Column(sql_type: str, *, column_name: str | None = None, description: str | None = None) -> Any:
    try:
    ...
    return Field(description=description, json_schema_extra=json_schema_extra)
