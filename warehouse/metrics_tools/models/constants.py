...
superchain_audit_start = coalesce_str(
    ["SQLMESH_DEBUG_START", "SQLMESH_DEBUG_SUPERCHAIN_AUDIT_START"], "2021-12-01"
)
...
superchain_audit_end = coalesce_str(
    ["SQLMESH_DEBUG_SUPERCHAIN_AUDIT_END"], "2025-05-31"
)
...
github_api_change_date = coalesce_start_value("GITHUB_API_CHANGE_DATE", "2025-10-07")
