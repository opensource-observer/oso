...
class ProtocolMetadata(BaseModel):
    ...
    id: str | None = Column(
        "VARCHAR", description="The unique identifier for the protocol"
    )
    ...
    address: str | None = Column(
        "VARCHAR", description="The contract address of the protocol"
    )
    symbol: str | None = Column(
        "VARCHAR", description="The token symbol of the protocol"
    )
    url: str | None = Column("VARCHAR", description="The website URL of the protocol")
    description: str | None = Column(
        "VARCHAR", description="A description of the protocol"
    )
    logo: str | None = Column("VARCHAR", description="URL to the protocol's logo")
    chain: str | None = Column(
        "VARCHAR", description="The primary chain the protocol operates on"
    )
    category: str | None = Column("VARCHAR", description="The category of the protocol")
    twitter: str | None = Column(
        "VARCHAR", description="The Twitter handle of the protocol"
    )
    parent_protocol: str | None = Column(
        "VARCHAR", description="The parent protocol if this is a sub-protocol"
    )
    dlt_load_id: str | None = Column(
        "VARCHAR",
        column_name="_dlt_load_id",
        description="Internal value used by DLT indicating when the row was loaded",
    )
    dlt_id: str | None = Column(
        "VARCHAR",
        column_name="_dlt_id",
        description="Internal unique value for the row",
    )
