MODEL (
  name metrics.int_superchain_onchain_builder_filter,
  kind FULL,
);

@DEF(min_transaction_threshold, 1000);
@DEF(min_gas_threshold, 0);
@DEF(min_address_threshold, 420);
@DEF(min_day_threshold, 10);
