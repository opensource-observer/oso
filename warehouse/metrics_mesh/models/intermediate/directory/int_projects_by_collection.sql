...
from @oso_source('bigquery.oso.stg_ossd__current_collections') as stg_ossd__current_collections
cross join UNNEST(stg_ossd__current_collections.projects) as cc(project_name)
inner join @oso_source('bigquery.oso.stg_ossd__current_projects') as stg_ossd__current_projects
