...
SELECT
  ...
  @oso_id(all_tvl_events.chain, all_tvl_events.slug) as to_artifact_source_id,
  @from_artifact_name as from_artifact_name,
  @from_artifact_namespace as from_artifact_namespace,
  @from_artifact_type as from_artifact_type,
  @oso_id(all_tvl_events.chain, all_tvl_events.token) as from_artifact_source_id,
