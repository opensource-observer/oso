{#
  This model is responsible for generating a many-to-many table
  of artifacts associated with a user. This includes
  both GitHub users and various onchain users.
#}
