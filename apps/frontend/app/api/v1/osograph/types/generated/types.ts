...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  DatasetTypeDefinition:
    | (Omit<DataConnectionDefinition, "dataConnectionAlias"> & {
        dataConnectionAlias: _RefType["DataConnectionAlias"];
      })
    | (Omit<DataIngestionDefinition, "dataIngestion"> & {
        dataIngestion?: Maybe<_RefType["DataIngestion"]>;
      })
    | (Omit<DataModelDefinition, "dataModels"> & {
        dataModels: _RefType["DataModelConnection"];
      })
    | (Omit<StaticModelDefinition, "staticModels"> & {
        staticModels: _RefType["StaticModelConnection"];
      });
  TableSource:
    | DataConnectionAliasRow
    | DataIngestionsRow
...
export type ResolversTypes = {
  ...
  DataConnectionAlias: ResolverTypeWrapper<
    Omit<DataConnectionAlias, "materializations" | "modelContext"> & {
      materializations: ResolversTypes["MaterializationConnection"];
  ...
  >;
  DataConnectionDefinition: ResolverTypeWrapper<
    Omit<DataConnectionDefinition, "dataConnectionAlias"> & {
      dataConnectionAlias: ResolversTypes["DataConnectionAlias"];
    }
  >;
  ...
  >;
  DataIngestionDefinition: ResolverTypeWrapper<
    Omit<DataIngestionDefinition, "dataIngestion"> & {
      dataIngestion?: Maybe<ResolversTypes["DataIngestion"]>;
    }
  >;
  ...
  >;
  DataModelDefinition: ResolverTypeWrapper<
    Omit<DataModelDefinition, "dataModels"> & {
      dataModels: ResolversTypes["DataModelConnection"];
    }
  >;
  ...
  >;
  OrganizationMember: ResolverTypeWrapper<
    Omit<OrganizationMember, "user"> & { user: ResolversTypes["User"] }
  >;
  ...
  >;
  StaticModel: ResolverTypeWrapper<StaticModelsRow>;
  StaticModelConnection: ResolverTypeWrapper<
    Omit<StaticModelConnection, "edges"> & {
      edges: Array<ResolversTypes["StaticModelEdge"]>;
    }
  >;
  StaticModelDefinition: ResolverTypeWrapper<
    Omit<StaticModelDefinition, "staticModels"> & {
      staticModels: ResolversTypes["StaticModelConnection"];
    }
  >;
  ...
  Table: ResolverTypeWrapper<
    Omit<Table, "columns" | "dataset" | "source"> & {
      columns: Array<ResolversTypes["TableColumn"]>;
      dataset: ResolversTypes["Dataset"];
      source: ResolversTypes["TableSource"];
    }
  >;
  ...
  >;
  Viewer: ResolverTypeWrapper<
    Omit<
      Viewer,
      "datasets" | "invitations" | "notebooks" | "organizations" | "runs"
    > & {
      datasets: ResolversTypes["DatasetConnection"];
      invitations: ResolversTypes["InvitationConnection"];
      notebooks: ResolversTypes["NotebookConnection"];
      organizations: ResolversTypes["OrganizationConnection"];
      runs: ResolversTypes["RunConnection"];
    }
  >;
};
...
export type ResolversParentTypes = {
  ...
  DataConnectionAlias: Omit<
    DataConnectionAlias,
    "materializations" | "modelContext"
  > & {
    materializations: ResolversParentTypes["MaterializationConnection"];
  ...
  DataConnectionDefinition: Omit<
    DataConnectionDefinition,
    "dataConnectionAlias"
  > & { dataConnectionAlias: ResolversParentTypes["DataConnectionAlias"] };
  ...
  DataIngestionDefinition: Omit<DataIngestionDefinition, "dataIngestion"> & {
    dataIngestion?: Maybe<ResolversParentTypes["DataIngestion"]>;
  };
  ...
  DataModelDefinition: Omit<DataModelDefinition, "dataModels"> & {
    dataModels: ResolversParentTypes["DataModelConnection"];
  };
  ...
  OrganizationMember: Omit<OrganizationMember, "user"> & {
  ...
  StaticModel: StaticModelsRow;
  StaticModelConnection: Omit<StaticModelConnection, "edges"> & {
    edges: Array<ResolversParentTypes["StaticModelEdge"]>;
  };
  StaticModelDefinition: Omit<StaticModelDefinition, "staticModels"> & {
    staticModels: ResolversParentTypes["StaticModelConnection"];
  };
  ...
  Table: Omit<Table, "columns" | "dataset" | "source"> & {
    columns: Array<ResolversParentTypes["TableColumn"]>;
    dataset: ResolversParentTypes["Dataset"];
    source: ResolversParentTypes["TableSource"];
  };
  ...
  Viewer: Omit<
    ...
    "datasets" | "invitations" | "notebooks" | "organizations" | "runs"
  > & {
    datasets: ResolversParentTypes["DatasetConnection"];
    invitations: ResolversParentTypes["InvitationConnection"];
    notebooks: ResolversParentTypes["NotebookConnection"];
    organizations: ResolversParentTypes["OrganizationConnection"];
    runs: ResolversParentTypes["RunConnection"];
  };
};
