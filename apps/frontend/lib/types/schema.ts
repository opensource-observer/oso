...
export const runInsertSchema = z.object({
  ...
  retry_number: z.number().optional(),
...
export const runRelationshipsSchema = z.tuple([
  z.object({
    foreignKeyName: z.literal("fk_run_parent"),
    columns: z.tuple([z.literal("parent_run_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("run"),
    referencedColumns: z.tuple([z.literal("id")]),
  }),
  ...
  z.object({
    foreignKeyName: z.literal("run_parent_run_id_fkey"),
    columns: z.tuple([z.literal("parent_run_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("run"),
    referencedColumns: z.tuple([z.literal("id")]),
