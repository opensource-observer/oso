...
export const resourcePermissionsRowSchema = z.object({
  ...
  created_at: z.string(),
  data_connection_id: z.string().nullable(),
  data_ingestion_id: z.string().nullable(),
  data_model_id: z.string().nullable(),
  ...
  static_model_id: z.string().nullable(),
  updated_at: z.string(),
...
export const resourcePermissionsInsertSchema = z.object({
  ...
  created_at: z.string().optional(),
  data_connection_id: z.string().optional().nullable(),
  data_ingestion_id: z.string().optional().nullable(),
  data_model_id: z.string().optional().nullable(),
  ...
  static_model_id: z.string().optional().nullable(),
  updated_at: z.string().optional(),
...
export const resourcePermissionsRelationshipsSchema = z.tuple([
  ...
  z.object({
    foreignKeyName: z.literal("resource_permissions_data_connection_id_fkey"),
    columns: z.tuple([z.literal("data_connection_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("dynamic_connectors"),
    referencedColumns: z.tuple([z.literal("id")]),
  ...
  z.object({
    foreignKeyName: z.literal("resource_permissions_data_ingestion_id_fkey"),
    columns: z.tuple([z.literal("data_ingestion_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("data_ingestions"),
    referencedColumns: z.tuple([z.literal("id")]),
  }),
  z.object({
    foreignKeyName: z.literal("resource_permissions_data_model_id_fkey"),
    columns: z.tuple([z.literal("data_model_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("model"),
    referencedColumns: z.tuple([z.literal("id")]),
  }),
  z.object({
    foreignKeyName: z.literal("resource_permissions_dataset_id_fkey"),
    columns: z.tuple([z.literal("dataset_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("datasets"),
    referencedColumns: z.tuple([z.literal("id")]),
  ...
  z.object({
    foreignKeyName: z.literal("resource_permissions_org_id_fkey"),
    columns: z.tuple([z.literal("org_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("organizations"),
    referencedColumns: z.tuple([z.literal("id")]),
  ...
  z.object({
    foreignKeyName: z.literal("resource_permissions_static_model_id_fkey"),
    columns: z.tuple([z.literal("static_model_id")]),
    isOneToOne: z.literal(false),
    referencedRelation: z.literal("static_model"),
    referencedColumns: z.tuple([z.literal("id")]),
  }),
  z.object({
