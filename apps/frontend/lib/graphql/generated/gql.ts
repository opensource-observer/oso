...
const documents: Documents = {
  ...
  "\n      query GetDataIngestionConfig($datasetId: ID!) {\n        datasets(where: { id: { eq: $datasetId }}, single: true) {\n          edges {\n            node {\n              id\n              typeDefinition {\n                ... on DataIngestion {\n                  id\n                  datasetId\n                  factoryType\n                  config\n                  createdAt\n                  updatedAt\n                }\n              }\n            }\n          }\n        }\n      }\n    ":
    types.GetDataIngestionConfigDocument,
  "\n      query GetDataIngestionRuns($where: JSON, $first: Int, $after: String) {\n        runs(where: $where, first: $first, after: $after) {\n          edges {\n            node {\n              id\n              datasetId\n              status\n              queuedAt\n              startedAt\n              finishedAt\n              logsUrl\n              steps {\n                edges {\n                  node {\n                    id\n                    name\n                    displayName\n                    status\n                    startedAt\n                    finishedAt\n                    logsUrl\n                  }\n                }\n              }\n            }\n            cursor\n          }\n          pageInfo {\n            hasNextPage\n            hasPreviousPage\n            startCursor\n            endCursor\n          }\n          totalCount\n        }\n      }\n    ":
    types.GetDataIngestionRunsDocument,
  "\nquery AssetGraph {\n  assetNodes {\n    assetKey {\n      path\n    }\n    dependencyKeys {\n      path\n    }\n  }\n}":
