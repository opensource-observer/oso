...
const documents: Documents = {
  "\n  query ResolveOrganization($where: JSON) {\n    organizations(first: 1, single: true, where: $where) {\n      edges {\n        node {\n          id\n          name\n        }\n      }\n    }\n  }\n":
    types.ResolveOrganizationDocument,
  "\n  query MarketplaceDatasets(\n    $first: Int\n    $after: String\n    $search: String\n    $datasetType: DatasetType\n    $orgId: ID!\n  ) {\n    marketplaceDatasets(\n      orgId: $orgId\n      first: $first\n      after: $after\n      search: $search\n      datasetType: $datasetType\n    ) {\n      edges {\n        node {\n          id\n          name\n          displayName\n          description\n          type\n          updatedAt\n          organization {\n            name\n            displayName\n          }\n          tables(first: 0) {\n            totalCount\n          }\n          isSubscribed(orgId: $orgId)\n        }\n        cursor\n      }\n      pageInfo {\n        hasNextPage\n        hasPreviousPage\n        startCursor\n        endCursor\n      }\n      totalCount\n    }\n  }\n":
    types.MarketplaceDatasetsDocument,
  "\n  mutation SubscribeToDataset($input: SubscribeToDatasetInput!) {\n    subscribeToDataset(input: $input) {\n      success\n      message\n    }\n  }\n":
    types.SubscribeToDatasetDocument,
  "\n  mutation UnsubscribeFromDataset($input: UnsubscribeFromDatasetInput!) {\n    unsubscribeFromDataset(input: $input) {\n      success\n      message\n    }\n  }\n":
    types.UnsubscribeFromDatasetDocument,
  "\n  query GetPreviewData($datasetId: ID!, $tableName: String!) {\n    datasets(where: { id: { eq: $datasetId } }, single: true) {\n      edges {\n        node {\n          id\n          typeDefinition {\n            __typename\n            ... on DataModelDefinition {\n              dataModels(where: { name: { eq: $tableName } }, single: true) {\n                edges {\n                  node {\n                    id\n                    name\n                    previewData {\n                        isAvailable\n                        rows\n                    }\n                  }\n                }\n              }\n            }\n            ... on StaticModelDefinition {\n              staticModels(where: { name: { eq: $tableName } }, single: true) {\n                edges {\n                  node {\n                    id\n                    name\n                    previewData {\n                      isAvailable\n                      rows\n                    }\n                  }\n                }\n              }\n            }\n            ... on DataIngestionDefinition {\n              dataIngestion {\n                id\n                previewData(tableName: $tableName) {\n                  isAvailable\n                  rows\n                }\n              }\n            }\n            ... on DataConnectionDefinition {\n              dataConnectionAlias {\n                id\n                schema\n                previewData(tableName: $tableName) {\n                  isAvailable\n                  rows\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n":
