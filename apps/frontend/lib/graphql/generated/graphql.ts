...
export type GetDataIngestionConfigQueryVariables = Exact<{
  datasetId: Scalars["ID"]["input"];
}>;

export type GetDataIngestionConfigQuery = {
  __typename?: "Query";
  datasets: {
    __typename?: "DatasetConnection";
    edges: Array<{
...
>;
export const GetDataIngestionConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetDataIngestionConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetDataIngestionConfigQuery,
  GetDataIngestionConfigQueryVariables
>;
