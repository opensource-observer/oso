...
- If you want to download a snapshot of the data, the easiest way is to download it directly from BigQuery. Check out the [Getting Started](../getting-started) guide.
