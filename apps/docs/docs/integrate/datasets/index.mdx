...
import CryptoEcosystemsLogo from "./crypto-ecosystems-logo.jpeg";
import ElectricCapitalLogo from "./electric_capital_logo_transparent.png";
import GrowthepieLogo from "./growthepie_logo.png";
import GrowthepieFullLogo from "./growthepie_full_logo.png";
...
<div className="datalinks-container">
  ...
  <a href="#crypto-ecosystems" className="datalink-card">
    <div className="datalink-header">
      <img src={CryptoEcosystemsLogo} alt="CryptoEcosystemsLogo" className="datalink-logo" />
      <span className="tag">Updated daily</span>
    </div>
  ...
  <a href="#growthepie" className="datalink-card">
    <div className="datalink-header">
      <img src={GrowthepieLogo} alt="Growthepie Logo" className="datalink-logo" />
      <span className="tag">Updated daily</span>
    </div>
    <h3>growthepie</h3>
  </a>
...
<img src={OpenSourceInsights} height="50" />
...
<img src={ElectricCapitalLogo} height="50" />
...
<img src={EthereumLogo} height="50" />
...
<img src={OptimismLogo} height="50" />
...
<img src={ArbitrumLogo} height="50" />
...
<img src={GrowthepieFullLogo} height="50" />
...
<Button
  ...
  target={"_blank"}
  link={
    "https://console.cloud.google.com/bigquery/analytics-hub/discovery/projects/opensource-observer/locations/us/dataExchanges/open_source_observer_190181416ae/listings/growthepie_198a2464823"
  }
  children={"Subscribe on BigQuery"}
/>{" "}

The project [growthepie](https://growthepie.xyz/) aims to enhance transparency and understanding of the Ethereum ecosystem by providing comprehensive, curated data, analysis and educational resources to users, developers and chain teams. The project is MIT licensed.

OSO mirrors a copy of the growthepie **fundamentals** dataset and hosts it on BigQuery. You can read more about this dataset [here](https://docs.growthepie.xyz/api).
...
SELECT
  date,
  value
FROM `YOUR_PROJECT_NAME.growthepie.fundamentals_full`
WHERE
  origin_key = 'ethereum'  
  AND metric_key = 'market_cap_usd'
ORDER BY date DESC
LIMIT 30
```
...
<img src={FilecoinLogo} height="50" />
...
This dataset mirrors the dataset offered by [EAS](https://attest.org/) for use in the OSO data pipeline, currently showing all attestations on the Optimism network.
...
<img src={FarcasterLogo} height="50" />
