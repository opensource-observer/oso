...
Follow the [API key creation guide](../get-started/api.mdx) to generate your key.
...
You can also view the [model lineage](https://dagster.oso.xyz/assets/sqlmesh?view=folder) in our
