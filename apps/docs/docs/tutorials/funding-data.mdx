...
<SankeyChart 
  data={[
    ['Funder A', 'Project X', 12345],
    ['Funder A', 'Project Y', 6780],
    ['Funder B', 'Project X', 4321],
    ['Funder C', 'Project Z', 9100],
    ['Funder D', 'Project A', 5500],
    ['Funder A', 'Project B', 3200],
    ['Funder B', 'Project C', 7800],
    ['Funder D', 'Project D', 4100]
  ]}
  width={800}
  height={600}
/>
