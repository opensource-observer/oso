...
<SankeyChart 
  data={[
    ['Optimism (Retro Funding)', 'rotki', 773567.405],
    ['Optimism (Retro Funding)', 'Giveth', 763501.50597262],
    ['Optimism (Retro Funding)', 'growthepie', 591839.955],
    ['Optimism (Retro Funding)', 'The Metagovernance Project', 445164.86],
    ['Gitcoin (Matching)', 'rotki', 437212.3154683],
    ['Arbitrum STIP', 'Tally', 350000.0],
    ['Optimism (Retro Funding)', 'Tally', 347827.48],
    ['Optimism (Retro Funding)', 'Praise', 277324.575],
    ['Optimism (Gov Grants)', 'Tally', 272000.0],
    ['Optimism (Gov Grants)', 'growthepie', 271250.0],
    ['Octant', 'rotki', 264978.05933],
    ['Optimism (Retro Funding)', 'BrightID', 260870.61],
    ['Optimism (Gov Grants)', 'The Metagovernance Project', 218750.0],
    ['Optimism (Gov Grants)', 'Praise', 196000.0],
    ['Gitcoin (Matching)', 'BrightID', 167265.35932253],
    ['Octant', 'growthepie', 160926.51583],
    ['Gitcoin (Donations)', 'rotki', 159744.88374017],
    ['Optimism (Gov Grants)', 'rotki', 155385.0],
    ['Optimism (Gov Grants)', 'Glo Dollar', 150000.0],
    ['Gitcoin (Matching)', 'DAppNode', 145749.1293857],
    ['Optimism (Gov Grants)', 'Giveth', 114000.0],
    ['Gitcoin (Donations)', 'BrightID', 111565.00896218],
    ['Octant', 'Praise', 97426.29811],
    ['Octant', 'Giveth', 93294.031],
    ['Gitcoin (Matching)', 'Giveth', 90637.65480067],
    ['Optimism (Gov Grants)', 'DAppNode', 87500.0],
    ['Gitcoin (Donations)', 'DAppNode', 82407.68490584],
    ['Gitcoin (Matching)', 'The Metagovernance Project', 75029.40650066],
    ['Optimism (Gov Grants)', 'MetaGame', 67900.0],
    ['Gitcoin (Matching)', 'growthepie', 52982.04462797],
    ['Gitcoin (Donations)', 'Giveth', 52791.59537782],
    ['Stellar Community Fund', 'Giveth', 50000.0],
    ['Octant', 'MetaGame', 41578.274],
    ['Gitcoin (Matching)', 'Glo Dollar', 33483.09845652],
    ['Gitcoin (Donations)', 'The Metagovernance Project', 30596.10273279],
    ['Octant', 'DAppNode', 27295.39723],
    ['Octant', 'Glo Dollar', 24511.97],
    ['DAO Drops', 'Giveth', 18186.0],
    ['Octant', 'BrightID', 13053.2],
    ['Stellar Community Fund', 'Glo Dollar', 13000.0],
    ['DAO Drops', 'MetaGame', 11287.0],
    ['DAO Drops', 'rotki', 10863.0],
    ['Gitcoin (Donations)', 'MetaGame', 10676.41343911],
    ['DAO Drops', 'The Metagovernance Project', 10439.0],
    ['Gitcoin (Matching)', 'MetaGame', 7134.3403956],
    ['Gitcoin (Matching)', 'Tally', 6410.53183881],
    ['Gitcoin (Donations)', 'Glo Dollar', 6292.65612837],
    ['Octant', 'The Metagovernance Project', 6251.63472],
    ['Gitcoin (Donations)', 'growthepie', 5564.21808437],
    ['DAO Drops', 'Praise', 5326.0],
    ['clr.fund', 'BrightID', 4256.11048459],
    ['Gitcoin (Donations)', 'Praise', 2839.37634001],
    ['clr.fund', 'DAppNode', 2236.97136264],
    ['Gitcoin (Matching)', 'Praise', 1902.04135822],
    ['Gitcoin (Donations)', 'Tally', 1469.24947999],
    ['clr.fund', 'rotki', 1416.56143556]
  ]}
  width={800}
  height={600}
/>
