...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8u0yNVg3vXsq/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: bBICBhwqdJEn/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__biONf)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tP53A)}
                role={"img"}
              />
            ),
